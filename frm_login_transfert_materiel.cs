...
namespace frm_menu
{
    public partial class frm_login_transfert_materiel : Form
    {
        //*****************************************************************************
        ...
        public frm_login_transfert_materiel()
        {
            InitializeComponent();
        }
        ...
        //*******************************Traitements Stock*****************************
        //*****************************************************************************
        #region Bouton Radio Stock

        // Bouton CSAPA
        private void RADIO_csapa_CheckedChanged(object sender, EventArgs e)
        {
            #region Cache stock
            PIC_stock.Visible = false;
            TXTBX_nom_stock.Visible = false;
            #endregion
        ...
        //Bouton MAP
        private void RADIO_map_CheckedChanged(object sender, EventArgs e)
        {
            #region Cache stock
            PIC_stock.Visible = false;
            TXTBX_nom_stock.Visible = false;
        ...
        //Bouton SULLY
        private void RADIO_sully_CheckedChanged(object sender, EventArgs e)
        {
            #region Cache stock
            PIC_stock.Visible = false;
            TXTBX_nom_stock.Visible = false;
        ...
        //Bouton Plus
        private void RADIO_plus_CheckedChanged(object sender, EventArgs e)
        {
            #region Visibilité stock
            PIC_stock.Visible = true;
            TXTBX_nom_stock.Visible = true;
            #endregion
        ...
        #region Zone de texte Stock

        private void TXTBX_nom_stock_MouseClick(object sender, MouseEventArgs e)
        {
            #region Visibilité claviers
            PNL_clavier.Visible = true;
            PNL_pave_numeric.Visible = true;
        ...
        private void BTN_valider_Click(object sender, EventArgs e)
        {
            ...
            // Si identification valide ouvrir le formulaire de RETRAIT pour les usagers
            frm_transfert_stock f = new frm_transfert_stock();
            f.Show();
            this.Hide();
            //}
        }
        ...
        private void BTN_clavier_a_Click(object sender, EventArgs e)
        {
            ...
            //Si le focus est sur le textbox nom de stock
            else if (Action == "STOCK_plus")
            {
